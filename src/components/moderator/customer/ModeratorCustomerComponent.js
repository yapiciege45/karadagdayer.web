...
export const ModeratorCustomerComponent = ({ distributors, packages, passport, passport_verify, id, token, proxy, diploma, criminal_record, proxy_verify, diploma_verify, criminal_record_verify, session_date, company_setup_date, session_end_date, name = '', img = '', surname = '', address, company_name = '', email = '', password = '', phoneCode = '', phone = '', distributorId, packageId, getCustomers }) => {
    ...
    const [changableDistributorId, setChangableDistributorId] = useState(distributorId)
