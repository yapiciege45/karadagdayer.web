...
import { AdminCustomerComponent, AdminDistributorComponent, AdminEmployeeComponent } from './AdminCustomerComponent'

export const AdminCustomerPageComponent = ({ addNewCustomer, customers, token, getCustomers, distributors, packages }) => {
  return (
