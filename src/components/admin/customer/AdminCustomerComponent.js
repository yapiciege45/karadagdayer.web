...
export const AdminCustomerComponent = ({ distributors, passport, passport_verify, packages, id, token, proxy, diploma, criminal_record, proxy_verify, diploma_verify, criminal_record_verify, session_date, company_setup_date, session_end_date, name = '', img = '', surname = '', address, debt, payment, company_name = '', email = '', password = '', phoneCode = '', phone = '', distributorId = 0, packageId, getCustomers }) => {
